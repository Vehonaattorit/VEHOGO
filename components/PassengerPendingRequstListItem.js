      ...
      <View style={styles.rectangle}>
        <View style={styles.topRow}>
          ...
          <View style={styles.marginLeft}>
            <Text style={styles.userNameText}>{item.driverName}</Text>
          </View>
        ...
        <View style={styles.bottomRow}>
          ...
          />
          <View style={styles.marginLeft}>
            <Text style={styles.homeAddressText}>{item.driverAddress}</Text>
          </View>
        </View>
        <View style={styles.breakPoint}></View>
...
export default PassengerPendingRequestListITem
